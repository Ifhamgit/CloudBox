...
const Signup = (props) => {
  ...
  const [focusedN, setFocusedN] = useState(false);
  const [focusedP, setFocusedP] = useState(false);
  const [focusedE, setFocusedE] = useState(false);
  const [focusedCP, setFocusedCP] = useState(false);
  ...
  <form onSubmit={handleSubmit}>
    ...
    <label className={focusedN ? "d-none" : ""}>Name</label>
      <input type="text" name="name" onChange= {onchangeN}  required=""/>
    </div>

    <div className="user-box">
    <label className={focusedE ? "d-none" : ""}>Email</label>
      <input type="email" name="email"  onChange={onchangeE} required=""/>
    </div>

    <div className="user-box">
    <label className={focusedP ? "d-none" : ""}>Password</label>
      <input type="password"  onChange={onchangeP} name="password" minLength={5} required/>
    </div>

    <div className="user-box">
    <label className={focusedCP ? "d-none" : ""}>Confirm Password</label>
      <input type="password"  onChange={onchangeCP} name="cpassword" minLength={5} required/>
